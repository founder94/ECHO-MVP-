...
await build({
  ...
  define: { 'import.meta.env': JSON.stringify({ VITE_PUBLIC_SUPABASE_URL: 'http://localhost:4650', VITE_PUBLIC_SUPABASE_ANON_KEY: 'stub-anon', VITE_A_STRUCTURE_SERVER_ENABLED: 'true', VITE_SITE_ROLE: 'app', DEV: false, PROD: true, MODE: 'production' }), 'process.env.NODE_ENV': '"production"' },
  logLevel: 'warning',
