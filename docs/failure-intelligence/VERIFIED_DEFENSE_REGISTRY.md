...
| 질문 선택사항(막히면 반응만 · question=null 정상) | GF-02 · GF-03 · GF-07 · GF-10 | B-1.0 | MOCK_VERIFIED | 통과 | 통과(누수 검사 포함) | — | [REAL run1] 앱 실패 안내 0(A 는 6) · 반응만 보낸 턴 4 — 멈춘 느낌인지는 블라인드 | 대화가 멈춘 느낌 — 블라인드 검수 필요 |
