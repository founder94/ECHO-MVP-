...
test('필수 3개(약관·개인정보·만19세)가 전부 켜져야 계속할 수 있다; 마케팅은 선택', () => {
  ...
  assert.equal(c.allChecked({ terms: true, privacy: true, age19: true, marketing: false }), false);
  assert.deepEqual(plain(c.setAll(true)), { terms: true, privacy: true, age19: true, marketing: true });
