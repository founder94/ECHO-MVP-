...
// 실행: node --experimental-strip-types --test spike/agent-v1-20260925/candidate-v3.1.test.mjs
...
test('서비스 설명에 질문 개수 약속 0', () => {
  ...
  assert.equal(A.AGENT_VERSION, 'echo-agent-v3.1');
});
...
test('H3 · P0-3 물음이 둘이면 살려 쓰지 않는다(아무 문장이나 질문 승격 0)', () => {
