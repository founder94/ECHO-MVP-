// 휴대폰 시험 페이지 만들기: agent.mjs 를 글자 그대로 넣는다(export 낱말만 뺀다). 페이지와 OpenAI 재생이 같은 에이전트를 쓰는지 검사가 대조한다.
...
export function buildPage() {
  ...
  if (!tpl.includes('/*__AGENT__*/')) throw new Error('template marker missing');
  return tpl.replace('/*__AGENT__*/', () => agent);
}
