...
export const AGENT_VERSION = "echo-agent-v2.4"; // v2.4(2026-09-26 run 20 실제 AI 실패 CORRECTION_IGNORED): 「아니 …」로 시작하는 새 뜻을 answer 로 읽어 옛 값이 안 밀림 → 서버 정정 가드. v2.3(사람 말투) 포함 // v2.3(2026-09-26 대표 「HUMAN UX」 · 제안판 · 실제 AI 검사·배포 승인 전): 받아주기 평가 말 금지 · 질문 더 밝고 가볍게 // v2.0(2026-09-26 AI OS 최소 운영형): 서버 말 종류 가드 · 정정 시 같은 목적 옛 뜻 교체 · 거절 뜻 소개 차단
